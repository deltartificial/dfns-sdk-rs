...
mod tests {
    ...
    fn test_raw_signature_to_asn1_with_leading_one() {
        let mut raw_signature = vec![0; 64];
        raw_signature[0] = 0x80; // Set high bit in first byte of r
        let asn1 = raw_signature_to_asn1(&raw_signature);
        assert_eq!(
            asn1,
            vec![
                0x30, 0x26, // SEQUENCE of length 38
                0x02, 0x21, // INTEGER of length 33
                0x00, 0x80, // Value for r with padding
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x02, 0x01, // INTEGER of length 1
                0x00  // Value for s
            ]
        );
    }
    ...
    #[test]
    fn test_raw_signature_to_asn1_both_padded() {
        let mut raw_signature = vec![0; 64];
        raw_signature[0] = 0x80; // Set high bit in first byte of r
        raw_signature[32] = 0x80; // Set high bit in first byte of s
        let asn1 = raw_signature_to_asn1(&raw_signature);
        assert_eq!(
            asn1,
            vec![
                0x30, 0x46, // SEQUENCE of length 70
                0x02, 0x21, // INTEGER of length 33
                0x00, 0x80, // Value for r with padding
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x02, 0x21, // INTEGER of length 33
                0x00, 0x80, // Value for s with padding
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00
            ]
